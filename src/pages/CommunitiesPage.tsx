      ...
      <div className="relative z-10 mx-auto w-full max-w-[680px] px-6 py-6 space-y-6">
        ...
        <div className="flex items-center justify-between pb-3 border-b border-white/[0.07]">
          <div className="flex items-center gap-2">
            <h1 className="text-[17px] font-bold text-white tracking-tight">c/communities</h1>
            <span className="hidden sm:inline text-[11px] text-gray-600 font-mono">• PCCOE Student Clubs & Hubs</span>
          </div>
        ...
        <div className="bg-[#0A0A0F] border border-white/[0.08] rounded-2xl p-8 text-center space-y-4 shadow-lg">
          <div className="w-12 h-12 rounded-2xl bg-[#35C1B5]/10 border border-[#35C1B5]/20 flex items-center justify-center mx-auto text-[#35C1B5]">
            <Users className="w-6 h-6" />
          </div>
          <div className="space-y-1">
            <h2 className="text-lg font-bold text-white">Communities</h2>
            <p className="text-xs text-gray-400 max-w-md mx-auto">
              Discover, join, and create branch-wise and interest-based clubs at PCCOE.
            </p>
          </div>
          <div className="pt-2">
            <button className="inline-flex items-center gap-2 bg-[#35C1B5] hover:bg-[#2db3a8] text-white text-xs font-semibold px-4 py-2 rounded-xl transition-all shadow-md">
