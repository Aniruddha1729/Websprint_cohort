...
export default function LiquidEther({
  ...
  const effectiveColors = (color0 || color1 || color2)
  ...
  useEffect(() => {
    ...
    const bgVec4 = new THREE.Vector4(0.04, 0.02, 0.09, 0.85);
    ...
    class CommonClass {
      ...
      init(container: HTMLElement) {
        ...
        this.renderer.setClearColor(new THREE.Color(0x050509), 0);
    ...
    class MouseClass {
      ...
      coords: THREE.Vector2 = new THREE.Vector2(0.1, 0.1);
      coords_old: THREE.Vector2 = new THREE.Vector2(0.08, 0.08);
      diff: THREE.Vector2 = new THREE.Vector2(0.02, 0.02);
      timer: number | null = null;
      container: HTMLElement | null = null;
      docTarget: Document | null = null;
      listenerTarget: Window | HTMLElement | null = null;
      isHoverInside: boolean = false;
      hasUserControl: boolean = false;
      isAutoActive: boolean = true;
    ...
    class AutoDriver {
      ...
      constructor(mouse: MouseClass, manager: any, opts: any) {
        ...
        this.resumeDelay = 0; // immediate start
        this.rampDurationMs = (opts.rampDuration || 0) * 1000;
        this.active = true;
        this.current = new THREE.Vector2(-0.5, -0.3);
        this.target = new THREE.Vector2(0.5, 0.4);
      ...
      update() {
        ...
        dir.normalize();
        const step = (this.speed + 0.15) * dtSec;
...
`;
    ...
    void main(){
      ...
      float lenv = clamp(speed * 4.0 + 0.22, 0.0, 1.0);
      vec3 c = texture2D(palette, vec2(lenv, 0.5)).rgb;
      vec3 outRGB = mix(bgColor.rgb, c, lenv);
      float outA = mix(bgColor.a, 0.95, lenv);
...
`;
    ...
    class Simulation {
      ...
      getFloatType() {
        // HalfFloatType ensures compatible linear filtering on WebGL2 across GPUs
